...
const LANDSCAPE_TREES_PALMS = compactSeeds([
  ...
  { id: "live-oak", name: "Live Oak", sci: "Quercus virginiana", cat: "Native Shrub", layer: "Overstory", zones: ["8b", "9a", "9b", "10a"], nat: true, eat: false, h: [40, 80], s: [40, 80], tags: ["native", "landscape"], guild: ["Wildlife Habitat", "Wind Break"], note: "Iconic Florida shade tree; acorns for wildlife." },
  { id: "red-maple", name: "Red Maple", sci: "Acer rubrum", cat: "Native Shrub", layer: "Overstory", zones: ["8a", "8b", "9a"], nat: true, eat: false, h: [40, 60], s: [25, 35], tags: ["native", "landscape"], guild: ["Wildlife Habitat"] },
  { id: "southern-magnolia", name: "Southern Magnolia", sci: "Magnolia grandiflora", cat: "Native Shrub", layer: "Overstory", zones: ["8a", "8b", "9a", "9b"], nat: true, eat: false, h: [40, 80], s: [20, 40], tags: ["native", "landscape"], guild: ["Wildlife Habitat"] },
